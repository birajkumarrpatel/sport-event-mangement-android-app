...
import com.example.dell.teamup.ViewTeamMembers;
 ...
 */
public class CapHome extends android.support.v4.app.Fragment implements View.OnClickListener{
    View myView;
    FloatingActionButton idFab, idFab1;
    TextView febmessage;
    private Animation fab_open, fab_close, rotate_forward, rotate_backward;
    private Boolean isFabOpen = false;
    private static final String URL_PRODUCTS = "http://teamupyou.xyz/Api_n.php";
    List<Product> productList;
    RecyclerView recyclerView;
    Context c;
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {

        myView = inflater.inflate(R.layout.tabcaphome, container, false);
        c = getActivity();
        ...
        idFab1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent i2 = new Intent(getActivity(), ViewTeamMembers.class);
                startActivity(i2);
            }
        });
