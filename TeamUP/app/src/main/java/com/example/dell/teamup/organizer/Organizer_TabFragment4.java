...
import com.example.dell.teamup.Adapters.ProductsAdapter2;
...
public class Organizer_TabFragment4 extends Fragment {
    View myView;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, Bundle savedInstanceState) {
        myView = inflater.inflate(R.layout.organizer_tabfragment4, container, false);
        c=getActivity();
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            ProductsAdapter2 adapter = new ProductsAdapter2(getActivity(), productList);
